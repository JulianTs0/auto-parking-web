...
export abstract class AuthDataSourceI {
    ...
    abstract registerEmployee(dto: RegisterEmployeeReq): Promise<void>;
    abstract getOwnerRequests(dto: GetOwnerRequestReq): Promise<GetOwnerRequestRes>;
    abstract acceptOwnerRequest(dto: AcceptOwnerRequestReq): Promise<void>;
    abstract requestOwnerUpgrade(dto: RequestOwnerUpgradeReq): Promise<void>;
